        ...
        <footer className="grid-x">
          <div className="cell large-4 medium-3 small-12">
            ...
            <p className="small-text">
              TAIBU Community Health Centre provides primary health care and
              related services for Black populations across the Greater Toronto
              Area and residents of our local community of Malvern. Recognizing
              that systemic oppression has fostered conditions of ill-health
              with Black communities, we strive to deliver these services
              through intersectional, equity-based and culturally affirming
              practices which promote holistic wellness, health education, and
              prevention.
            </p>
          </div>
